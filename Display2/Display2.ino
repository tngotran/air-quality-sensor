...
void setup()
{
  ...
  lcd.setCursor(18, 0);  lcd.print("CO2:");
  lcd.setCursor(18, 2);  lcd.print("TVoC");
...
void readAllBytes()
{
  ...
  statu = I2c.receive();
  resistance = (I2c.receive()& 0x00)| (I2c.receive()<<16)| (I2c.receive()<<8| I2c.receive());
...
void checkStatus()
{
  ...
  else if(statu == 0x00)
  {
    ...
    lcd.setCursor(18, 1);  lcd.print(predict);
    lcd.setCursor(18, 3);  lcd.print(tvoc);
  }
  else if(statu == 0x01)
  {
    Serial.println("Busy");
    printIAQLCD("sensor","busy")
  }
  else if(statu == 0x80)
  {
    Serial.println("Error");
    printIAQLCD("status","error")
  }
  else{
    Serial.println("No Status, check module");
    printIAQLCD("plz chek","sensor")
  }
}
void printIAQLCD(String st1,String st2)
{

  lcd.setCursor(18, 1);  lcd.print(st1);
  lcd.setCursor(18, 3);  lcd.print(st2);
